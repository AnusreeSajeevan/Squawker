package android.example.com.squawker.service;
...
/**
 * listens for squawk fcm messages both in the foreground and in the background
 * and responds appropriately depending on the type of the message
 */
public class SquawkerFirebaseMessagingService extends FirebaseMessagingService {
    ...
    /**
     * method called on receiving message from fcm
     * @param remoteMessage object representing message from fcm
     */
    @Override
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (stringMap.size() > 0){
            sendNotification(stringMap);
            insertSquawk(stringMap);
        }
    }
